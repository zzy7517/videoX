...
2. 角色名需要有且精准的指向性，不要出现骑士1，骑士2此类的名称
3. 根据剧本中的描述、对话和行为推断每个角色的性格、年龄、服装和外观特征
4. 对于未明确描述外观的角色，请基于角色的身份、社会地位、情感状态和剧本的整体风格提供合理的视觉特征
5. 描述要具体、详细，且适合用于AI文生图(text-to-image)，使用的模型为stablediffusion或者flux
6. 使用英文输出，20个词以内
